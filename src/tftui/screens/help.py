...
KEYS: tuple[tuple[str, str, str], ...] = (
    ...
    ("Enter", "View the highlighted resource", "Navigate"),
    ("Esc", "Go back to the state tree", "Navigate"),
    ("/", "Filter the tree by text in names and definitions", "Navigate"),
    ("0-9", "Collapse the tree to a module depth; 0 expands everything", "Navigate"),
    ("Space", "Select or deselect the highlighted resource", "Select"),
